[![CircleCI](https://circleci.com/gh/Zenardi/project-ml-microservice-kubernetes.svg?style=svg)](https://circleci.com/gh/Zenardi/project-ml-microservice-kubernetes)
...
### Kubernetes Clean Up
- `kubectl delete deployment.apps/udacity-pred-app`
- `kubectl delete svc udacity-pred-app`
